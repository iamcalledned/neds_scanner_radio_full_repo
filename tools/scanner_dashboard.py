...
SERVICES: List[ServiceDef] = SCANNER_SERVICES + LLM_SERVICES
...
class ScannerControlRoom(App):
    ...
    def _set_status(self, msg: str) -> None:
        status_id = "#llm_statusbar" if self._is_llm_unit(self.selected_unit) else "#statusbar"
    ...
    def _services_for_unit(self, unit: str) -> List[ServiceDef]:
        return LLM_SERVICES if self._is_llm_unit(unit) else SCANNER_SERVICES
